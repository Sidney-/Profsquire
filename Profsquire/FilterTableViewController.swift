...
class FilterTableViewController: UITableViewController {
    ...
    override func viewDidLoad() {
        ...
        noneDuplicatedDepartment.append("All Departments")
    ...
    override func tableView(tableView: UITableView, numberOfRowsInSection section: Int) -> Int {
        ...
        return noneDuplicatedDepartment.count
    }
    ...
    override func tableView(tableView: UITableView, cellForRowAtIndexPath indexPath: NSIndexPath) -> UITableViewCell {
        ...
        cell.textLabel?.text = noneDuplicatedDepartment[indexPath.row]
    ...
    override func prepareForSegue(segue: UIStoryboardSegue, sender: AnyObject?) {
        ...
        if segue.identifier == "unwind" {
            ...
            if let indexPath = self.tableView.indexPathForSelectedRow {
                ...
                if object == "All Departments" {
                    
                    controller.showFilterOfCourse = false
                    
                } else {
                
                    controller.showFilterOfCourse = true
